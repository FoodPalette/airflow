...
'신논현역', '신도림역', '신림역', '신촌역', '연신내역', '왕십리역', '장지역', '장한평역', '천호역',\ 
 '혜화역', '홍대입구역', '회기역', '가락시장', '가로수길', '김포공항', '낙산공원', '노량진', '덕수궁길',\ 
'정동길', '방배역', '북촌한옥마을', '서촌', '성수카페거리', '수유리', '쌍문동', '압구정로데오거리',\
 '여의도', '연남동', '외대앞', '용리단길', '이태원', '인사동', '익선동', '창동', \
'청담동', '청량리', '해방촌', '경리단길', 'DDP', 'DMC', '강서한강공원', '고척돔', \
'광나루한강공원', '국립중앙박물관', '용산가족공원', '난지한강공원', '남산공원', \
'노들섬', '뚝섬한강공원', '망원한강공원', '반포한강공원', '북서울꿈의숲', '불광천', '서리풀공원',\ 
'몽마르뜨공원', '서울숲공원', '시청광장', '아차산', '양화한강공원', '어린이대공원', '여의도한강공원',\ 
'월드컵공원', '응봉산', '이촌한강공원', '잠실종합운동장', '잠실한강공원', '잠원한강공원', '청와대']
...
dag = DAG(
    dag_id='daily_crawling_00020240224',
...
daily_get_keyword = PythonOperator(
    task_id='daily_get_keyword_task00020240224',
